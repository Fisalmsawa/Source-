...
if User_Sudo ~= '' then
local GetInfoUser = https.request('https://api.telegram.org/bot'..token..'/getchat?chat_id='..User_Sudo)
local User_Info = JSON.decode(GetInfoUser) 
if User_Info.ok == false then
io.write('\n\27[1;31m Bad UserId \n\27[0;39;49m')
os.exit()
end
io.write('\n\27[1;31m• Sudo id saved. \n\27[0;39;49m')
print(User_Info.username,User_Info.id)
redis:set(Server_Devid.."User_Devbots1",User_Info.username)
redis:set(Server_Devid.."Id_Devbotsid",User_Info.id)
else
...
local Status = redis:sismember(bot_id.."Eqap:Developer:Bot1", user) 
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_Bots_User1 = true  
end  
...
local Dev_Bots_User1 = false  
local Status = redis:sismember(bot_id.."Eqap:Developer:Bot", user) 
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_Bots_User1 = true  
end  
...
local Status = redis:sismember(bot_id.."Eqap:Developer:Bot1", msg.sender_user_id_) 
...
local Status = redis:sismember(bot_id.."Eqap:Developer:Bot", msg.sender_user_id_) 
...
local hash = redis:sismember(bot_id.."Eqap:President:Group"..msg.chat_id_, msg.sender_user_id_) 
...
local hash = redis:sismember(bot_id..'Eqap:Constructor:Group'..msg.chat_id_, msg.sender_user_id_) 
...
function Owner(msg)
local hash = redis:sismember(bot_id..'Eqap:Manager:Group'..msg.chat_id_,msg.sender_user_id_)    
...
function Admin(msg)
local hash = redis:sismember(bot_id..'Eqap:Admin:Group'..msg.chat_id_,msg.sender_user_id_)    
...
function Vips(msg)
local hash = redis:sismember(bot_id..'Eqap:Vip:Group'..msg.chat_id_,msg.sender_user_id_) 
...
Status = true  
elseif redis:sismember(bot_id..'Eqap:Manager:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember(bot_id..'Eqap:Admin:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember(bot_id..'Eqap:Vip:Group'..chat_id, user_id) then  
Status = false  
else  
Status = false  
end  
...
elseif redis:sismember(bot_id..'Eqap:Constructor:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."Eqap:Constructor:Group:Reply"..chat_id) or "المنشئ"  
elseif redis:sismember(bot_id..'Eqap:Manager:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."Eqap:Manager:Group:Reply"..chat_id) or "المدير"  
elseif redis:sismember(bot_id..'Eqap:Admin:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."Eqap:Admin:Group:Reply"..chat_id) or "الادمن"  
elseif redis:sismember(bot_id..'Eqap:Vip:Group'..chat_id, user_id) then  
Status = redis:get(bot_id.."Eqap:Vip:Group:Reply"..chat_id) or "المميز"  
else  
Status = redis:get(bot_id.."Eqap:Mempar:Group:Reply"..chat_id) or "العضو"
end  
return Status
end 
------------------------------------------------------------------------------------------------------------
function ChekBotAdd(chat_id)
if redis:sismember(bot_id.."Eqap:ChekBotAdd",chat_id) then
Status = true
else 
Status = false
end
...
if redis:sismember(bot_id.."Eqap:Removal:User:Group"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if redis:sismember(bot_id.."Eqap:Removal:User:Groups",User_id) then
Status = true
else
Status = false
end
...
if redis:sismember(bot_id.."Eqap:Silence:User:Groups",User_id) then
Status = true
else
Status = false
end
...
NAME = 'Eqap Chat'
link = redis:get(bot_id.."Eqap:link:set:Group"..msg.chat_id_) or ''
ASAS = redis:smembers(bot_id..'Eqap:President:Group'..v)
MNSH = redis:smembers(bot_id..'Eqap:Constructor:Group'..v)
MDER = redis:smembers(bot_id..'Eqap:Manager:Group'..v)
MOD = redis:smembers(bot_id..'Eqap:Admin:Group'..v)
if k == 1 then
t = t..'"'..v..'":{"Eqap":"'..NAME..'",'
else
t = t..',"'..v..'":{"Eqap":"'..NAME..'",'
...
redis:sadd(bot_id..'Eqap:ChekBotAdd',idg)  
...
redis:sadd(bot_id..'Eqap:Constructor:Group'..idg,idmsh)
end
end
if v.MDER then
for k,idmder in pairs(v.MDER) do
redis:sadd(bot_id..'Eqap:Manager:Group'..idg,idmder)  
end
end
if v.MOD then
for k,idmod in pairs(v.MOD) do
redis:sadd(bot_id..'Eqap:Admin:Group'..idg,idmod)  
end
end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
redis:sadd(bot_id..'Eqap:President:Group'..idg,idASAS)  
end
end
end
...
redis:incr(bot_id..'Eqap:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) 
TypeForChat = 'ForSuppur' 
elseif id:match("^(%d+)") then
redis:sadd(bot_id..'Eqap:Num:User:Pv',msg.sender_user_id_)  
TypeForChat = 'ForUser' 
else
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."Eqap:Lock:text"..msg.chat_id_) and not Vips(msg) then       
Delete_Message(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(bot_id.."Eqap:Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if redis:get(bot_id.."Eqap:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if redis:get(bot_id.."Eqap:Lock:Join"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Photo"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Photo"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Photo"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Video"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Video"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Video"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Animation"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Animation"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Animation"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:geam"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:geam"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:geam"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Audio"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Audio"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Audio"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:vico"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:vico"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:vico"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Keyboard"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Keyboard"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Sticker"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Sticker"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Sticker"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:forward"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get(bot_id.."Eqap:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get(bot_id.."Eqap:Lock:forward"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get(bot_id.."Eqap:Lock:forward"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if redis:get(bot_id.."Eqap:Lock:Document"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Document"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Document"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get(bot_id.."Eqap:Lock:Unsupported"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Unsupported"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Unsupported"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if redis:get(bot_id.."Eqap:Lock:Markdaun"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Markdaun"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Markdaun"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if redis:get(bot_id.."Eqap:Lock:Inlen"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Inlen"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Inlen"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if redis:get(bot_id.."Eqap:Lock:Contact"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Contact"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Contact"..msg.chat_id_) == "ktm" then
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
------------------------------------------------------------------------------------------------------
local status_welcome = redis:get(bot_id.."Eqap:Chek:Welcome"..msg.chat_id_)
if status_welcome and not redis:get(bot_id.."Eqap:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = redis:get(bot_id.."Eqap:Get:Welcome:Group"..msg.chat_id_)  
...
redis:set(bot_id.."Eqap:Get:Id:Msg:Pin"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = redis:get(bot_id.."Eqap:Get:Id:Msg:Pin"..msg.chat_id_)
if Msg_Pin and redis:get(bot_id.."Eqap:lockpin"..msg.chat_id_) then
Pin_Message(msg.chat_id_,Msg_Pin)
end
end
end
--------------------------------------------------------------------------------------------------------------
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= bot_id then
floods = redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(redis:get(bot_id.."Eqap:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
redis:setex(bot_id.."Eqap:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--------------------------------------------------------------------------------------------------------------
if msg.content_.photo_ then  
if redis:get(bot_id.."Eqap:Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
redis:set(bot_id..'Eqap:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
redis:set(bot_id..'Eqap:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
redis:set(bot_id..'Eqap:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
redis:set(bot_id..'Eqap:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
redis:del(bot_id.."Eqap:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
...
if redis:get(bot_id.."BotEqap:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n〽تم الغاء الاذاعه للمجموعات") 
redis:del(bot_id.."BotEqap:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers(bot_id.."Eqap:ChekBotAdd") 
send(msg.chat_id_, msg.id_,"☑تمت الاذاعه الى *- "..#list.." * مجموعه في البوت ")     
...
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
redis:set(bot_id..'BotEqap:Msg:Pin:Chat'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
for k,v in pairs(list) do 
sendPhoto(v, 0, photo,(msg.content_.caption_ or ""))
redis:set(bot_id..'BotEqap:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
redis:set(bot_id..'BotEqap:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
redis:set(bot_id..'BotEqap:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
redis:del(bot_id.."BotEqap:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."Eqap:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
...
------------------------------------------------------------------------------------------------------------
if redis:get(bot_id.."Eqap:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
...
------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id.."Eqap:Command:Reids:Group:End"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
...
local test = redis:get(bot_id.."Eqap:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if redis:get(bot_id.."Eqap:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:del(bot_id.."Eqap:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
redis:set(bot_id.."Eqap:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
redis:set(bot_id.."Eqap:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
redis:set(bot_id.."Eqap:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
redis:set(bot_id.."Eqap:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
redis:set(bot_id.."Eqap:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
redis:set(bot_id.."Eqap:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
redis:del(bot_id.."Eqap:Add:Rd:Manager:Text"..text..msg.chat_id_)   
redis:del(bot_id.."Eqap:Add:Rd:Manager:Photo"..text..msg.chat_id_)
redis:del(bot_id.."Eqap:Add:Rd:Manager:Video"..text..msg.chat_id_)
redis:del(bot_id.."Eqap:Add:Rd:Manager:File"..text..msg.chat_id_)
redis:del(bot_id.."Eqap:Add:Rd:Manager:Audio"..text..msg.chat_id_)
redis:sadd(bot_id.."Eqap:List:Manager"..msg.chat_id_.."", text)
return false end
end
------------------------------------------------------------------------------------------------------------
if text and text:match("^(.*)$") then
...
redis:del(bot_id.."Eqap:Add:Rd:Manager:Audio"..text..msg.chat_id_)
redis:del(bot_id.."Eqap:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
redis:srem(bot_id.."Eqap:List:Manager"..msg.chat_id_.."", text)
return false
end
end
------------------------------------------------------------------------------------------------------------
if text and not redis:get(bot_id.."Eqap:Reply:Sudo"..msg.chat_id_) then
local anemi = redis:get(bot_id.."Eqap:Add:Rd:Sudo:Gif"..text)   
local veico = redis:get(bot_id.."Eqap:Add:Rd:Sudo:vico"..text)   
local stekr = redis:get(bot_id.."Eqap:Add:Rd:Sudo:stekr"..text)     
local Text = redis:get(bot_id.."Eqap:Add:Rd:Sudo:Text"..text)   
local photo = redis:get(bot_id.."Eqap:Add:Rd:Sudo:Photo"..text)
local video = redis:get(bot_id.."Eqap:Add:Rd:Sudo:Video"..text)
local document = redis:get(bot_id.."Eqap:Add:Rd:Sudo:File"..text)
local audio = redis:get(bot_id.."Eqap:Add:Rd:Sudo:Audio"..text)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = redis:get(bot_id..'Eqap:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local NumMessageEdit = redis:get(bot_id..'Eqap:Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text and not redis:get(bot_id.."Eqap:Reply:Manager"..msg.chat_id_) then
if not redis:sismember(bot_id..'Eqap:Spam_For_Bot'..msg.sender_user_id_,text) then
local anemi = redis:get(bot_id.."Eqap:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = redis:get(bot_id.."Eqap:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = redis:get(bot_id.."Eqap:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = redis:get(bot_id.."Eqap:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = redis:get(bot_id.."Eqap:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = redis:get(bot_id.."Eqap:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = redis:get(bot_id.."Eqap:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = redis:get(bot_id.."Eqap:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = redis:get(bot_id..'Eqap:Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
...
------------------------------------------------------------------------------------------------------------
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = redis:get(bot_id.."Eqap:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:del(bot_id.."Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
redis:set(bot_id.."Eqap:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
redis:set(bot_id.."Eqap:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
redis:set(bot_id.."Eqap:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
...
if msg.content_.audio_ then
redis:set(bot_id.."Eqap:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
redis:set(bot_id.."Eqap:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
redis:set(bot_id.."Eqap:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
redis:del(bot_id.."Eqap:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
redis:srem(bot_id.."Eqap:List:Rd:Sudo", text)
return false
end
end
...
if text then   
redis:set(bot_id.."Eqap:Filter:Reply2"..test..msg.chat_id_, text)  
end  
redis:del(bot_id.."Eqap:Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_)  
return false 
end  
end
...
redis:setex(bot_id..'Eqap:Ban:Cmd:Start'..msg.sender_user_id_,60,true)
return false
end
...
if text and text:match("^(.*)$") then
if redis:get(bot_id.."Eqap:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nتم حفظ السؤال بنجاح')
redis:set(bot_id.."Eqap:gamebot:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1uu")
...
redis:srem(bot_id..'Eqap:Num:User:Pv',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = redis:smembers(bot_id..'Eqap:ChekBotAdd')  
local w = 0
local q = 0
for i = 1, #group do
...
redis:srem(bot_id..'Eqap:ChekBotAdd',group[i])  
w = w + 1
end
...
redis:sadd(bot_id.."Eqap:Removal:User:Groups", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."Eqap:Removal:User:Groups", result.sender_user_id_)
...
redis:sadd(bot_id.."Eqap:Silence:User:Groups", result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."Eqap:Silence:User:Groups", result.sender_user_id_)
...
if redis:get(bot_id..'Eqap:Lock:Ban:Group'..msg.chat_id_) and not Owner(msg) then
...
redis:sadd(bot_id.."Eqap:Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
...
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
...
redis:srem(bot_id.."Eqap:Silence:kid:User:Group"..msg.chat_id_,result.sender_user_id_)
...
redis:sadd(bot_id.."Eqap:Silence:kid:User:Group"..msg.chat_id_,result.sender_user_id_)
...
redis:srem(bot_id.."Eqap:Removal:User:Groups", result.id_)
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
end
...
redis:srem(bot_id.."Eqap:Silence:User:Groups", result.id_)
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
end
...
redis:sadd(bot_id.."Eqap:Removal:User:Group"..msg.chat_id_, result.id_)
...
if text and text:match("^انذار @(.*)$") and Admin(msg) and not redis:get(bot_id..'Eqap:inthar:group'..msg.chat_id_) then
function FunctionStatus(arg, result)
if (result.id_) then
if Rank_Checking(result.id_, msg.chat_id_) == true then
return send(msg.chat_id_, msg.id_, "\nلا تستطيع انذار: "..Get_Rank(result.id_,msg.chat_id_).." ")
end
local numinthar = tonumber(redis:get(bot_id.."Eqap:inthar"..msg.chat_id_..result.id_) or 0)
if numinthar == 0 then
redis:set(bot_id.."Eqap:inthar"..msg.chat_id_..result.id_,'1')
...
redis:set(bot_id.."Eqap:inthar"..msg.chat_id_..result.id_,'2')
elseif numinthar == 2 then
Send_Options(msg,result.id_,"reply","تم كتمه \n لانه تجاوز حد 3 انذارات")  
redis:del(bot_id.."Eqap:inthar"..msg.chat_id_..result.id_)
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_, result.id_)
end
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
if text == ("انذار") and tonumber(msg.reply_to_message_id_) ~= 0 and Admin(msg) and not redis:get(bot_id..'Eqap:inthar:group'..msg.chat_id_) then
function FunctionStatus(arg, result)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
return send(msg.chat_id_, msg.id_, "\nلا تستطيع انذار: "..Get_Rank(result.sender_user_id_,msg.chat_id_).." ")
end
local numinthar = tonumber(redis:get(bot_id.."Eqap:inthar"..msg.chat_id_..result.sender_user_id_) or 0)
if numinthar == 0 then
redis:set(bot_id.."Eqap:inthar"..msg.chat_id_..result.sender_user_id_,'1')
Send_Options(msg,result.id_,"reply","تم اعطائه انذار \n تبقى له انذارين ويتم كتمه")  
elseif numinthar == 1 then
Send_Options(msg,result.id_,"reply","تم اعطائه انذار \n تبقى له انذار و يتم كتمه")  
redis:set(bot_id.."Eqap:inthar"..msg.chat_id_..result.sender_user_id_,'2')
elseif numinthar == 2 then
Send_Options(msg,result.id_,"reply","تم كتمه \n لانه تجاوز حد 3 انذارات")  
redis:del(bot_id.."Eqap:inthar"..msg.chat_id_..result.sender_user_id_)
redis:sadd(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
redis:del(bot_id..'Eqap:inthar:group'..msg.chat_id_) 
Text = '\n تم تفعيل الانذارات' 
send(msg.chat_id_, msg.id_,Text) 
end
...
redis:sadd(bot_id.."Eqap:Silence:kid:User:Group"..msg.chat_id_,result.id_)
...
if (result.id_) then
redis:srem(bot_id.."Eqap:Silence:kid:User:Group"..msg.chat_id_,result.id_)
...
redis:srem(bot_id.."Eqap:Removalked:User:Groups", result.id_)
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
redis:sadd(bot_id.."Eqap:Removalked:User:Groups", result.sender_user_id_)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."Eqap:Removalked:User:Groups", result.sender_user_id_)
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.sender_user_id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."Eqap:President:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."Eqap:President:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd(bot_id.."Eqap:Constructor:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."Eqap:Constructor:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
redis:sadd(bot_id.."Eqap:President:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."Eqap:President:Group"..msg.chat_id_, result.id_)
...
redis:sadd(bot_id.."Eqap:Constructor:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."Eqap:Constructor:Group"..msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
redis:setex(bot_id.."BotEqap:Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"ارسل لي المنشور الان\n〽يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n⚠لالغاء الاذاعه ارسل : الغاء") 
return false
end
...
local Added_Me = redis:get(bot_id.."Eqap:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
local Set_Rules = redis:get(bot_id.."Eqap::Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
cr = "منشئ ،" else cr = "" end
if redis:sismember(bot_id..'Eqap:Manager:Group'..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if redis:sismember(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if redis:sismember(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_)
elseif redis:sismember(bot_id.."Eqap:Developer:Bot1",msg.sender_user_id_) then
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id.."Eqap:President:Group"..msg.chat_id_,result.id_)
elseif redis:sismember(bot_id.."Eqap:Developer:Bot",msg.sender_user_id_) then
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id.."Eqap:President:Group"..msg.chat_id_,result.id_)
elseif redis:sismember(bot_id.."Eqap:President:Group"..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Manager:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Constructor:Group'..msg.chat_id_, result.id_)
elseif redis:sismember(bot_id..'Eqap:Constructor:Group'..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Manager:Group'..msg.chat_id_, result.id_)
elseif redis:sismember(bot_id..'Eqap:Manager:Group'..msg.chat_id_, msg.sender_user_id_) then
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.id_)
end
end
...
cr = "منشئ ،" else cr = "" end
if redis:sismember(bot_id..'Eqap:Manager:Group'..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if redis:sismember(bot_id..'Eqap:Admin:Group'..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if redis:sismember(bot_id..'Eqap:Vip:Group'..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
if redis:get(bot_id.."Eqap:lockpin"..msg.chat_id_) then    
lock_pin = "✔️"
else 
lock_pin = "✖"    
end
if redis:get(bot_id.."Eqap:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "✖"
end
if redis:get(bot_id.."Eqap:Lock:text"..msg.chat_id_) then    
lock_text = "← ✔️"
else 
lock_text = "← ✖"    
end
...
if redis:get(bot_id.."Eqap:Lock:edit"..msg.chat_id_) then    
lock_edit = "← ✔️"
else 
lock_edit = "← ✖"    
end
if redis:get(bot_id.."Eqap:Chek:Welcome"..msg.chat_id_) then
welcome = "← ✔️"
else 
welcome = "← ✖"    
end
if redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "← بالطرد"     
elseif redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "← بالتقييد "     
elseif redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "← بالكتم"           
elseif redis:hget(bot_id.."Eqap:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "← ✔️"
else     
flood = "← ✖"     
end
...
if redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "← ✔️"
elseif redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "← بالتقييد "    
elseif redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "← بالكتم"    
elseif redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "← بالطرد"    
else
lock_links = "← ✖"    
end
if redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "← ✔️"
elseif redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "← بالتقييد "    
elseif redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "← بالكتم"   
elseif redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "← بالطرد"    
else
lock_cmds = "← ✖"    
end
if redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "← ✔️"
elseif redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "← بالتقييد "    
elseif redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "← بالكتم"    
elseif redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "← بالطرد"    
else
lock_user = "← ✖"    
end
if redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "← ✔️"
elseif redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "← بالتقييد "    
elseif redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "← بالكتم"    
elseif redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "← بالطرد"    
else
lock_hash = "← ✖"    
end
...
if redis:get(bot_id.."Eqap:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "← ✔️"
elseif redis:get(bot_id.."Eqap:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "← بالتقييد "   
elseif redis:get(bot_id.."Eqap:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "← بالطرد"    
else
lock_bots = "← ✖"    
end
...
if redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "← ✔️"
elseif redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "← بالتقييد "    
elseif redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "← بالكتم"    
elseif redis:get(bot_id.."Eqap:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "← بالطرد"    
else
lock_spam = "← ✖"    
end        
if not redis:get(bot_id.."Eqap:Reply:Manager"..msg.chat_id_) then
ReplyManager = "← ✔️"
else
ReplyManager = "← ✖"
end
if not redis:get(bot_id.."Eqap:Reply:Sudo"..msg.chat_id_) then
ReplySudo = "← ✔️"
else
ReplySudo = "← ✖"
end
if not redis:get(bot_id.."Eqap:Lock:Id:Photo"..msg.chat_id_)  then
IdPhoto = "← ✔️"
else
IdPhoto = "← ✖"
end
if not redis:get(bot_id.."Eqap:Lock:Id:Py:Photo"..msg.chat_id_) then
IdPyPhoto = "← ✔️"
else
IdPyPhoto = "← ✖"
end
...
if not redis:get(bot_id.."Eqap:Lock:Ban:Group"..msg.chat_id_)  then
Banusers = "← ✔️"
else
Banusers = "← ✖"
end
if not redis:get(bot_id.."Eqap:Cheking:Seted"..msg.chat_id_) then
Setusers = "← ✔️"
else
Setusers = "← ✖"
end
if redis:get(bot_id.."Eqap:Link_Group"..msg.chat_id_) then
Link_Group = "← ✔️"
else
Link_Group = "← ✖"
end
if not redis:get(bot_id.."Eqap:Fun:Group"..msg.chat_id_) then
FunGroup = "← ✔️"
else
FunGroup = "← ✖"
end
...
for k,v in pairs(list) do
redis:del(bot_id.."Eqap:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
redis:del(bot_id.."Eqap:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
redis:del(bot_id.."Eqap:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
redis:del(bot_id.."Eqap:Add:Rd:Manager:Text"..v..msg.chat_id_)   
redis:del(bot_id.."Eqap:Add:Rd:Manager:Photo"..v..msg.chat_id_)
redis:del(bot_id.."Eqap:Add:Rd:Manager:Video"..v..msg.chat_id_)
redis:del(bot_id.."Eqap:Add:Rd:Manager:File"..v..msg.chat_id_)
...
db = "متحركه "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف "
elseif redis:get(bot_id.."Eqap:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه "
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
for k,v in pairs(list) do
redis:del(bot_id.."Eqap:Add:Rd:Sudo:Gif"..v)   
redis:del(bot_id.."Eqap:Add:Rd:Sudo:vico"..v)   
redis:del(bot_id.."Eqap:Add:Rd:Sudo:stekr"..v)     
redis:del(bot_id.."Eqap:Add:Rd:Sudo:Text"..v)   
redis:del(bot_id.."Eqap:Add:Rd:Sudo:Photo"..v)
redis:del(bot_id.."Eqap:Add:Rd:Sudo:Video"..v)
redis:del(bot_id.."Eqap:Add:Rd:Sudo:File"..v)
...
db = "متحركه "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:vico"..v) then
db = "بصمه "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:stekr"..v) then
db = "ملصق "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:Text"..v) then
db = "رساله "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:Photo"..v) then
db = "صوره "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:Video"..v) then
db = "فيديو "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:File"..v) then
db = "ملف "
elseif redis:get(bot_id.."Eqap:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه "
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
local TextingDevStorm = redis:get(bot_id..'Eqap:Texting:DevSlbotss')
...
redis:del(bot_id.."Eqap:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","??","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
...
if redis:get(bot_id.."Eqap:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Eqap:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
redis:set(bot_id.."Eqap:Klam:Speed"..msg.chat_id_,name)
...
if text == "حزوره" then
if redis:get(bot_id.."Eqap:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Eqap:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
redis:set(bot_id.."Eqap:Klam:Hzor"..msg.chat_id_,name)
...
if text == "معاني" then
if redis:get(bot_id.."Eqap:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Eqap:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
redis:set(bot_id.."Eqap:Maany"..msg.chat_id_,name)
...
if text == "العكس" then
if redis:get(bot_id.."Eqap:Lock:Game:Group"..msg.chat_id_) then
redis:del(bot_id.."Eqap:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
redis:set(bot_id.."Eqap:Set:Aks:Game"..msg.chat_id_,name)
...
if redis:get(bot_id.."Eqap:Lock:Game:Group"..msg.chat_id_) then   
Num = math.random(1,6)
redis:set(bot_id.."Eqap:Games:Bat"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,[[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:del(bot_id.."Eqap:Set:Moktlf:Bot"..msg.chat_id_)
redis:set(bot_id.."Eqap::Set:Moktlf"..msg.chat_id_,name)
...
redis:set(bot_id.."Eqap:Set:Amth"..msg.chat_id_,name)
redis:del(bot_id.."Eqap:Set:Amth:Bot"..msg.chat_id_)
...
function Function_Status(extra, result, success)
if result.id_ then
if redis:sismember(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if redis:sismember(bot_id.."Eqap:Removal:User:Group"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if redis:sismember(bot_id.."Eqap:Removal:User:Groups",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
if redis:sismember(bot_id.."Eqap:Silence:User:Groups",result.id_) then
GBanss = "مكتوم عام"
else
...
function Function_Status(extra, result, success)
if redis:sismember(bot_id.."Eqap:Silence:User:Group"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if redis:sismember(bot_id.."Eqap:Removal:User:Group"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if redis:sismember(bot_id.."Eqap:Removal:User:Groups",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
if redis:sismember(bot_id.."Eqap:Silence:User:Groups",result.sender_user_id_) then
GBanss = "مكتوم عام"
else
GBanss = "غير مكتوم عام"
end
...
redis:sadd(bot_id..'Eqap:Admin:Group'..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
redis:srem(bot_id..'Eqap:Admin:Group'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
redis:sadd(bot_id..'Eqap:Admin:Group'..msg.chat_id_, admins[i].user_id_)
...
if text and text:match("^(.*)$") then
if redis:get(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
redis:set(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
redis:set(bot_id.."botss:Eqap:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
redis:sadd(bot_id.."botss:Eqap:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if redis:get(bot_id.."botss:Eqap:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
...
if redis:get(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:set(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = redis:get(bot_id.."botss:Eqap:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
redis:set(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = redis:get(bot_id.."botss:Eqap:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
redis:set(bot_id.."botss:Eqap:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
local NumMessageEdit = redis:get(bot_id..'Eqap:Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = redis:get(bot_id.."Eqap:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_) or 0
...
redis:sadd(bot_id..'Eqap:Num:User:Pv',v) 
end
...
if redis:get(bot_id..'Eqap:new:sourse'..msg.chat_id_..msg.sender_user_id_) == 'true2' then
redis:set(bot_id..'Eqap:new:sourse2',text)
redis:del(bot_id..'Eqap:new:sourse'..msg.chat_id_..msg.sender_user_id_) 
...
local list1 = redis:smembers(bot_id.."Eqap:Constructor:Group"..msg.chat_id_)
local list2 = redis:smembers(bot_id.."Eqap:Manager:Group"..msg.chat_id_)
...
if text and redis:get(bot_id.."Eqap:Command:Reids:Group:Del"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = redis:get(bot_id.."Eqap:Get:Reides:Commands:Group"..msg.chat_id_..":"..text)
if NewCmmd then
...
if text then
local NewCmmd = redis:get(bot_id.."Eqap:Get:Reides:Commands:Group"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
elseif text and not redis:sismember(bot_id..'Eqap:Spam_For_Bot'..msg.sender_user_id_,text) then
redis:del(bot_id..'Eqap:Spam_For_Bot'..msg.sender_user_id_) 
elseif msg.content_.ID == "MessageChatAddMembers" then  
redis:set(bot_id.."Eqap:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get(bot_id.."Eqap:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if redis:get(bot_id..'Eqap:ChekBot:Add'..msg.chat_id_) == 'addsender' then
...
owner_id = admins[i].user_id_
redis:sadd(bot_id.."Eqap:President:Group"..Chat_id, owner_id)
end
end
end,nil)   
...
if redis:get(bot_id.."Eqap:Lock:Link"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
...
if redis:get(bot_id.."Eqap:Lock:User:Name"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
elseif textedit and textedit:match("@") then
...
elseif textedit and textedit:match("(.*)(#)(.*)") then
if redis:get(bot_id.."Eqap:Lock:hashtak"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
elseif textedit and textedit:match("#") then
...
elseif textedit and textedit:match("/") then
if redis:get(bot_id.."Eqap:Lock:Cmd"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
elseif textedit and textedit:match("(.*)(/)(.*)") then
...
local Get_Msg_Pin = redis:get(bot_id..'BotEqap:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;redis:del(bot_id..'BotEqap:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) redis:del(bot_id..'BotEqap:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
redis:srem(bot_id..'Eqap:ChekBotAdd',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
redis:srem(bot_id..'Eqap:ChekBotAdd',v)  
end
...
redis:sadd(bot_id..'Eqap:ChekBotAdd',v)  
end 
end,nil)
end
end
